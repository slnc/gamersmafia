...
//		alert(_ret); 
    ...
    function _fill_area(){ 
        ...
        if(_is_fillarea){
        	...
        	// console.log(_fillcolors);
			// console.log(_filltop);
            _arr = _fillcolors; // _color(_fillcolors, _filltop).split(","); 
            // console.log(_arr); 
    ...
    function _options(options){ 
		...
		if (options.fillcolors) 
            _fillcolors = options.fillcolors;     
        else 
            _fillcolors = [];
		...
		if(options.max)
			_set_max(options.max);
			
		if(options.min)
			_set_min(options.min);
    ...
    return { 
        ...
        make    :   function(options){ 
			...
			if (options.linestyle)
				url += _param("line_style", options.linestyle);
