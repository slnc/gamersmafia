...
function tag_url(){
    ...
    var enterTITLE = prompt(text_enter_url_name, "texto");
...
function doInsert(ibTag, ibClsTag, isSingle){
    var isClose = false;
    var obj_ta = document.getElementById('comment_comment');
...
var text_enter_url = "Introduce la URL completa para el enlace";
var text_enter_url_name = "Introduce el nombre del enlace";
var text_enter_image = "Introduce la URL completa para la imagen";
var text_code = "Usage: [CODE] Your Code Here.. [/CODE]";
var text_quote = "Usage: [QUOTE] Your Quote Here.. [/QUOTE]";
var error_no_url = "Debes introducir una URL";
var error_no_title = "Debes introducir un título";
var error_no_width = "Debes introducir la anchura";
var error_no_height = "Debes introducir la altura";