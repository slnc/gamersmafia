...
class OutstandingUserTest < ActiveSupport::TestCase
  test "current_should_return_correct_user_case_a" do
    User.db_query("INSERT INTO stats.users_karma_daily_by_portal(user_id, portal_id, karma, created_on) VALUES(1, -1, 100, now() - '15 days'::interval)")
  ...
  test "current_should_return_correct_user_case_b" do
    ...
    User.db_query("INSERT INTO stats.users_karma_daily_by_portal(user_id, portal_id, karma, created_on) VALUES(2, -1, 50, now() - '15 days'::interval)")
    bu = OutstandingUser.current(-1)
    assert_not_nil bu
