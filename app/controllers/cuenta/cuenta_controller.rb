...
class Cuenta::CuentaController < ApplicationController
  ...
  def update_profile
    ...
    @newuser.pref_hw_heatsink = srip_tags(params[:post][:pref_hw_heatsink])
    ...
    @newuser.pref_hw_ssd = srip_tags(params[:post][:pref_hw_ssd])
    @newuser.pref_hw_powersupply = srip_tags(params[:post][:pref_hw_powersupply])
    @newuser.hw_soundcard = strip_tags(params[:post][:hw_soundcard])
    @newuser.pref_hw_case = srip_tags(params[:post][:pref_hw_case])
    @newuser.hw_monitor = strip_tags(params[:post][:hw_monitor])
    @newuser.hw_headphones = strip_tags(params[:post][:hw_headphones])
    @newuser.pref_hw_speakers = srip_tags(params[:post][:pref_hw_speakers])
    @newuser.hw_mouse = strip_tags(params[:post][:hw_mouse])
    @newuser.pref_hw_mousepad = srip_tags(params[:post][:pref_hw_mousepad])
    @newuser.pref_hw_keyboard = srip_tags(params[:post][:pref_hw_keyboard])
